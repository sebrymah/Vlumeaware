        ...
        <Table head={['Campaign', 'Status', 'Delivered', 'Click rate', 'Report rate', 'Date']}>
          {trend.map((r) => (
            <tr
              ...
              className={`cursor-pointer border-b border-slate-100 hover:bg-slate-100/40 ${
                selected === r.campaignId ? 'bg-slate-50' : ''
              }`}
            >
              <td className="px-2 py-2 text-brand-600">{r.name}</td>
